...
#Cleaning the data: selecting the relevant variables, filtering out "Do not read" values, and reorganizing the levels corresponding to races with those on the original graph
poll %>%
